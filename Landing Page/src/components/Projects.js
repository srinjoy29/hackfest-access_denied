...
import projImg1 from "../assets/img/service1.png";
  ...
  const projects = [
    {
      ...
      imgUrl: projImg4,
      buttonLink: "https://code-ad-2e5b13.netlify.app/",
    },
    {
    ...
    },
    {
      ...
      description: "CV Builder: Online tool to create professional resumes by providing templates, guiding content creation, and formatting, streamlining the job application process.",
      imgUrl: projImg1,
      buttonLink: "https://resume-builder-ad.netlify.app/",
    },
  ];
